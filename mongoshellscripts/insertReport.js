...
var dbUrl = "localhost:27017/cdmis"; // 服务器代码调试
print(dbUrl);
db = connect(dbUrl);
db.auth("admin", "zjubme319");
...
if (currentDay === 1) {
  ...
  for (let i = 0; i < patient.length; i++) {
    ...
    if (weekBP.length !== 0) {
      ...
      for (let n = 0; n < weekBP.length; n++) {
        ...
        if (recordTime !== new Date(weekBP[n].date)) {
          recordDays++;
        }
    ...
    if (weekWeight.length !== 0) {
      ...
      for (let n = 0; n < weekWeight.length; n++) {
        ...
        if (recordTime !== new Date(weekWeight[n].date)) {
          recordDays++;
        }
    ...
    if (weekVol.length !== 0) {
      ...
      for (let n = 0; n < weekVol.length; n++) {
        ...
        if (recordTime !== new Date(weekVol[n].date)) {
          recordDays++;
        }
    ...
    if (weekP.length !== 0) {
      ...
      for (let n = 0; n < weekP.length; n++) {
        ...
        if (recordTime !== new Date(weekP[n].date)) {
          recordDays++;
        }
    ...
    if (weekPD.length !== 0) {
      ...
      for (let n = 0; n < weekPD.length; n++) {
        ...
        if (recordTime !== new Date(weekPD[n].date)) {
          recordDays++;
        }
      ...
      for (let n = 0; n < recordTimeTemp.length; n++) {
        if (recordTimeTemp[n].getTime() === recordTime.getTime()) {
          // 时间的比较
          tempUF += weekPDTemp[n];
        } else {
      ...
      for (let n = 0; n < dataUFAll.length; n++) {
        startTime = new Date(
          recordTimeAll[n].getFullYear(),
          recordTimeAll[n].getMonth(),
          recordTimeAll[n].getDate(),
          "00",
          "00",
          "00"
        );
        endTime = new Date(
          recordTimeAll[n].getFullYear(),
          recordTimeAll[n].getMonth(),
          String(Number(recordTimeAll[n].getDate())),
          "23",
          "59",
          "59"
        );
  ...
  printjson({
    result: "insertWeekReport_success",
    insertWeekReport_item: patient.length,
    insertWeekReport_time: currentTime
  });
}
...
if (currentDate === 1) {
  ...
  if (lastTwoMonthsM < 10) {
    lastTwoMonthsM = "0" + lastTwoMonthsM;
  }
  ...
  for (let i = 0; i < patient.length; i++) {
    ...
    if (monthBP.length !== 0) {
      ...
      for (let n = 0; n < monthBP.length; n++) {
        ...
        if (recordTime !== new Date(monthBP[n].date)) {
          recordDays++;
        }
    ...
    if (monthWeight.length !== 0) {
      ...
      for (let n = 0; n < monthWeight.length; n++) {
        ...
        if (recordTime !== new Date(monthWeight[n].date)) {
          recordDays++;
        }
    ...
    if (monthVol.length !== 0) {
      ...
      for (let n = 0; n < monthVol.length; n++) {
        ...
        if (recordTime !== new Date(monthVol[n].date)) {
          recordDays++;
        }
    ...
    if (monthP.length !== 0) {
      ...
      for (let n = 0; n < monthP.length; n++) {
        ...
        if (recordTime !== new Date(monthP[n].date)) {
          recordDays++;
        }
    ...
    if (monthPD.length !== 0) {
      ...
      for (let n = 0; n < monthPD.length; n++) {
        ...
        if (recordTime !== new Date(monthPD[n].date)) {
          recordDays++;
        }
  ...
  printjson({
    result: "insertMonthReport_success",
    insertMonthReport_item: patient.length,
    insertMonthReport_time: currentTime
  });
}
...
if (currentDate === 1 && currentMonth % 3 === 1) {
  ...
  for (let i = 0; i < patient.length; i++) {
    ...
    if (seasonBP.length !== 0) {
      ...
      for (let n = 0; n < seasonBP.length; n++) {
        ...
        if (recordTime !== new Date(seasonBP[n].date)) {
          recordDays++;
        }
    ...
    query = {
      itemType: "BloodPressure",
      userId: patient[i].userId,
      $or: [{ time: monthsInSeason[0] }, { time: monthsInSeason[1] }, { time: monthsInSeason[2] }]
    };
    fields = {};
    var monthsReportCursor = db.reports.find(query, fields);
    var monthsReport = [];
    ...
    if (seasonWeight.length !== 0) {
      ...
      for (let n = 0; n < seasonWeight.length; n++) {
        ...
        if (recordTime !== new Date(seasonWeight[n].date)) {
          recordDays++;
        }
    ...
    if (seasonVol.length !== 0) {
      ...
      for (let n = 0; n < seasonVol.length; n++) {
        ...
        if (recordTime !== new Date(seasonVol[n].date)) {
          recordDays++;
        }
    ...
    if (seasonP.length !== 0) {
      ...
      for (let n = 0; n < seasonP.length; n++) {
        ...
        if (recordTime !== new Date(seasonP[n].date)) {
          recordDays++;
        }
    ...
    if (seasonPD.length !== 0) {
      ...
      for (let n = 0; n < seasonPD.length; n++) {
        ...
        if (recordTime !== new Date(seasonPD[n].date)) {
          recordDays++;
        }
  ...
  printjson({
    result: "insertSeasonReport_success",
    insertSeasonReport_item: patient.length,
    insertSeasonReport_time: currentTime
  });
}
...
if (currentMonth === 1 && currentDate === 1) {
  ...
  for (let i = 0; i < patient.length; i++) {
    ...
    if (yearBP.length !== 0) {
      ...
      for (let n = 0; n < yearBP.length; n++) {
        ...
        if (recordTime !== new Date(yearBP[n].date)) {
          recordDays++;
        }
    ...
    if (yearWeight.length !== 0) {
      ...
      for (let n = 0; n < yearWeight.length; n++) {
        ...
        if (recordTime !== new Date(yearWeight[n].date)) {
          recordDays++;
        }
    ...
    if (yearVol.length !== 0) {
      ...
      for (let n = 0; n < yearVol.length; n++) {
        ...
        if (recordTime !== new Date(yearVol[n].date)) {
          recordDays++;
        }
    ...
    if (yearP.length !== 0) {
      ...
      for (let n = 0; n < yearP.length; n++) {
        ...
        if (recordTime !== new Date(yearP[n].date)) {
          recordDays++;
        }
    ...
    if (yearPD.length !== 0) {
      ...
      for (let n = 0; n < yearPD.length; n++) {
        ...
        if (recordTime !== new Date(yearPD[n].date)) {
          recordDays++;
        }
  ...
  printjson({
    result: "insertYearReport_success",
    insertYearReport_item: patient.length,
    insertYearReport_time: currentTime
  });
}
